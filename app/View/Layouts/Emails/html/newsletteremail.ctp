...
<table width="500" border="0" cellpadding="10" cellspacing="0" style="margin:0px auto; background:#f0f0f0; text-align:center;">
	...
	<tr>
		<td>
        <h2>MTH Information</h2>
        <div style="text-align:left !important;">
        Hey Guest!<br /><br />

        We connect qualified and experienced massage therapists to the local demand for treatments.<br /><br />
        To become partners with us on My Treatment Hub platform you need to have<br /><br />
         -Certificate<br />
        -Right to work in UK<br />
        -Public Liability Insurance<br />
        -Massage Equipment<br /><br />
        
        Pay &#163;20 for two months as initial subscription charge and then &#163;20 per month for the following months.<br /><br />
        
        HURRY UP! JOIN NOW!<br />
        </div>
