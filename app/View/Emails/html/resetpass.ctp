...
<table width="500" border="0" cellpadding="0" cellspacing="0" style="margin:0px auto; background:#fff; text-align:center;">
  ...
  <tr>
    <td>
        ...
        <p style="color:#666;">Your request for Freelancer role on LOGO has been approved by Admin. <br /> 
Please Login to Continue!</p>  
        
        <a class="reset" style="background:#006500; 
		padding:15px 20px; 
		...
		font-weight:500;
                text-transform:uppercase;"  href="https://gurpreet.gangtask.com/cpanel">Login Here</a> 
